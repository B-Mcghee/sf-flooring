          ...
          <Flex justify="space-around">
            ...
            <Box textAlign="left" w="100%" m={2}>
              ...
              >
                ...
                leaving a lasting impression of beauty, durability, and comfort.
              </Text>
            </Box>
          </Flex>
          <Heading
          ...
          <Box ml={5}>
            ...
            <Box>
              ...
              >
                ...
                customers can make informed decisions about their flooring
                needs. We are dedicated to maintaining the highest standards of
                integrity and openness in all our interactions.
              </Text>
            </Box>
          </Box>
          <Box ml={5} mt={4}>
